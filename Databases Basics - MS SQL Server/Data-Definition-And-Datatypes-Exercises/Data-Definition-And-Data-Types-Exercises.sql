...
INSERT INT Users (Id, Username, Password, ProfilePicture)
VALUES (1, 'Name', 'Pass123456', @ProfilePicture)
 */
...
ALTER TABLE Payments
ADD CONSTRAINT CK_TaxAmount 
CHECK (TaxAmount = TotalDays * TaxRate);

INSERT INTO Payments (Id, EmployeeId, PaymentDate, AccountNumber, FirstDateOccupied, LastDateOccupied, TotalDays, AmountCharged, TaxRate, TaxAmount, PaymentTotal) VALUES 
